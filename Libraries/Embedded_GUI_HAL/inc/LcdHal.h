...
/* Includes ------------------------------------------------------------------*/
 ...
 #include "stm32HAL.h"
 #include "STM32F103C8T6/stm32f103c8t6_lcd.h"
...
{ 
    ...
    uint16_t	   LCD_Gpio_Pin_RST;
    uint16_t	   LCD_Gpio_Pin_RS;
