...
GPIO_TypeDef* FET_PORT[FETn] = {FET1_GPIO_PORT, FET2_GPIO_PORT};
const uint16_t FET_PIN[FETn] = {FET1_PIN, FET2_PIN};
const uint32_t FET_CLK[FETn] = {FET1_GPIO_CLK, FET2_GPIO_CLK};
...
/* Similar to LED Init but for FETs on the board */
void STM_EVAL_FETInit(FET_TypeDef FET)
{
  GPIO_InitTypeDef  GPIO_InitStructure;

  /* Enable the GPIO_FET Clock */
  RCC_APB2PeriphClockCmd(FET_CLK[FET], ENABLE);

  /* Configure the GPIO_FET pin */
  GPIO_InitStructure.GPIO_Pin = FET_PIN[FET];
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;

  GPIO_Init(FET_PORT[FET], &GPIO_InitStructure);
}
...
/**
  * @brief  Turns selected FET On.
  * @param  FET: Specifies the FET to be set on.
  *   This parameter can be one of following parameters:
  *     @arg FET1
  *     @arg FET2
  *     @arg FET3
...
{
  FET_PORT[FET]->BSRR = FET_PIN[FET];
}

/**
  * @brief  Turns selected FET Off.
  * @param  Led: Specifies the FET to be set off.
  *   This parameter can be one of following parameters:
  *     @arg FET1
  *     @arg FET2
  *     @arg FET3
...
{
  FET_PORT[FET]->BRR = FET_PIN[FET];
}

/**
  * @brief  Toggles the selected FET.
  * @param  FET: Specifies the FET to be toggled.
  *   This parameter can be one of following parameters:
  *     @arg FET1
  *     @arg FET2
  *     @arg FET3
