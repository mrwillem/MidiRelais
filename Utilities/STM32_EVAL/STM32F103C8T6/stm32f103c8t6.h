...
#define LED4_GPIO_CLK                    RCC_APB2Periph_GPIOC
 ...
 /** @addtogroup STM3210B_EVAL_LOW_LEVEL_LED
   ...
   */
 #define FETn                             2
 #define FET1_PIN                         GPIO_Pin_11
 #define FET1_GPIO_PORT                   GPIOA
 #define FET1_GPIO_CLK                    RCC_APB2Periph_GPIOA

 #define FET2_PIN                         GPIO_Pin_13
 #define FET2_GPIO_PORT                   GPIOA
 #define FET2_GPIO_CLK                    RCC_APB2Periph_GPIOA
...
void STM_EVAL_FETInit(FET_TypeDef FET);
void STM_EVAL_FETOn(FET_TypeDef FET);
void STM_EVAL_FETOff(FET_TypeDef FET);
void STM_EVAL_FETToggle(FET_TypeDef FET);
